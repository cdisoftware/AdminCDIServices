...
public class Controller {
    ...
    @Autowired
    ConsAdminPublicacionesService serviceConsAdminPublicacionesService;

    @Autowired
    ModAdminpublicacioneService serviceModAdminpublicacioneService;
    ...
    @GetMapping("/consultaservidors/{bandera}/{IpServidor}/{SO}/{Estado}/{TipoUser}")
    public List<ConsultaServidoresEntity> ConsultaServ(
            @PathVariable Integer bandera,
            @PathVariable String IpServidor,
            @PathVariable String SO,
            @PathVariable Integer Estado,
            @PathVariable String TipoUser) {
        return serviceConsultaServidoresService.ConsultaServ(bandera, IpServidor, SO, Estado, TipoUser);
    }
    ...
    @PostMapping("/consadminpublicaciones/{Bandera}/{TipoPublicacion}/{Estado}")
    public List<ConsAdminPublicacionesEntity> ConsAdminPublic(
            @RequestBody ConsAdminPublicacionesEntity entidad,
            @PathVariable Integer Bandera,
            @PathVariable Integer TipoPublicacion,
            @PathVariable Integer Estado) {
        return serviceConsAdminPublicacionesService.ConsAdminPublic(entidad, Bandera, TipoPublicacion, Estado);
    }

    @PostMapping("/modadminpublicaciones/{Bandera}")
    public String ModAdminPublic(
            @RequestBody ModAdminpublicacionesEntity entidad,
            @PathVariable Integer Bandera) {
        return serviceModAdminpublicacioneService.ModAdminPublic(entidad, Bandera);
    }
}
